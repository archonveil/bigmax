...
export default async function OrderReturnPage({ params }: PageProps): Promise<JSX.Element> {
  setRequestLocale(params.locale);
  const { initial } = await loadOrderReturnPage(params);
  return <OrderStatusView orderId={initial.id} variant="return" initial={initial} />;
}
